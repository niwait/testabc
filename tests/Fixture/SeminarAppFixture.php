 ...
 * SeminarAppFixture
 */
class SeminarAppFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'kana' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'カナ', 'precision' => null, 'fixed' => null],
        ...
        'tel' => ['type' => 'integer', 'length' => 16, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '電話番号', 'precision' => null, 'autoIncrement' => null],
