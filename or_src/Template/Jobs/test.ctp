    ...
    <div class="contents">
        ...
        <section class="cete-list-11">
            ...
            <ul>
                <li>
                    <label>
                        <select class="parent" id="" name="" disabled　required>
                            <option value="" class="cate-select11" disabled selected>大カテゴリー</option>
                            <option value="大カテゴリーA">大カテゴリーA</option>
                            <option value="大カテゴリーB">大カテゴリーB</option>
                            <option value="大カテゴリーC">大カテゴリーC</option>
                        </select>
                    </label>
                </li>
                <li>
                    <label>
                        <select class="children" id="" name="" disabled required>
                            <option value="" class="cate-select11" disabled selected>中カテゴリー</option>
                            <option value="中カテゴリーA-a" data-val="大カテゴリーA">中カテゴリーA-a</option>
                            <option value="中カテゴリーA-b" data-val="大カテゴリーA">中カテゴリーA-b</option>
                            <option value="中カテゴリーA-c" data-val="大カテゴリーA">中カテゴリーA-c</option>
                            <option value="中カテゴリーB-a" data-val="大カテゴリーB">中カテゴリーB-a</option>
                            <option value="中カテゴリーB-b" data-val="大カテゴリーB">中カテゴリーB-b</option>
                            <option value="中カテゴリーB-c" data-val="大カテゴリーB">中カテゴリーB-c</option>
                            <option value="中カテゴリーC-a" data-val="大カテゴリーC">中カテゴリーC-a</option>
                            <option value="中カテゴリーC-b" data-val="大カテゴリーC">中カテゴリーC-b</option>
                            <option value="中カテゴリーC-c" data-val="大カテゴリーC">中カテゴリーC-c</option>
                        </select>
                    </label>
                </li>
                <li>
            ...
            <div class="item00">
                    ...
                    <dl>
                        ...
                        <dd>
                            <section class="name-data">
                                <p class="name"><a href="">募集する仕事の内容のタイトル</a></p>
                                <p class="data">2020/07/25</p>
                            </section>
                            <p class="anything">会社名</p>
                            <section class="desc none-border">
                                <p>質問テキストが入ります。質問テキストが入ります。質問テキストが入ります。質問テキストが入ります。質問テキストが入ります。質問テキストが入ります。質問テキストが入ります。質問テキストが入ります。。</p>
                            </section>
                        </dd>
                    </dl>
                </article>
                <article class="item-cld-04">
                    <ul class="desc">
                        ...
                        <li>週4日（10時～20時）</li>
                        <li>仕事内容</li>
                        <li>Webデザイナー・クリエイター（UI/UX設計）</li>
                        <li>報酬</li>
                        <li>600,000〜1,200,000円</li>
                        <li>募集期間</li>
                        <li>2020/07/25～2020/09/25</li>
                    </ul>

                    <ul class="btn">
                        <li><p class="view-details"><a href="https://corp.rakuten.co.jp/socio/work/" target="_blank">詳細を見る</a></p></li>
                        <li><p class="Apply"><a href="oshigoto-entry.html">応募する</a></p></li>
                    </ul>
                </article>
            </div>
