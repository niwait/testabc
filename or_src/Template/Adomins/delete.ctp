                ...
                <div class="box-body">
                  ...
                  echo $this->Form->create(
                    ...
                    <tbody>
                      ...
                      <td>
                         <?php
                          echo $this->Form->control('questions.question_id', [
                                            'type'=>'text',
                                            'label' => false,
                                            'placeholder'=>"問題番号"
                        ...
                        <td><button class="btn btn-block" type="submit" name="questions[action]" value="question"><i class="fa fa-edit"></i>削除</button></td>
                      </tr>
                  ...
                  echo $this->Form->create(
                    ...
                    <tbody>
                      ...
                      <td>
                         <?php
                          echo $this->Form->control('responss.respons_id', [
                                            'type'=>'text',
                                            'label' => false,
                                            'placeholder'=>"解答番号"
                        ...
                        <td><button class="btn btn-block" type="submit" name="respons[action]" value="respons"><i class="fa fa-edit"></i>削除</button></td>
                      </tr>
