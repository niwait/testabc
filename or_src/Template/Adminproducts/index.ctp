      ...
      <div class="col-xs-12">
        <div class="box box-primary">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label for="InputEmail1">登録日</label>
                <?php
                  echo $this->Form->text('products.today', [
                    'input'=>'text',
                    'type'=>'date',
              ...
              <div class="form-group">
                <?php echo $this->Form->control('products.product', [
                  "label" => "製品・サービス名",
                  "class" => "form-control form-wide",
                  "value" =>"",
                ]); ?>
              ...
              <div class="form-group">
                <?php echo $this->Form->control('products.company', [
                  "label" => "会社名",
                  "class" => "form-control form-wide",
                  "value" => "",
                ]); ?>
              ...
              <div class="form-group">
                <?php echo $this->Form->control('products.text', [
                  "label" => "テキスト",
                  "class" => "form-control form-wide",
                  "value" => "",
                ]); ?>
              ...
              <div class="form-group">
                <?php echo $this->Form->control('products.mony', [
                  "label" => "利用料金",
                  "class" => "form-control form-wide",
                  "value" => "",
                ]); ?>
              ...
              <div class="form-group">
                <?php echo $this->Form->control('products.initial', [
                  "label" => "初期費用",
                  "class" => "form-control form-wide",
                  "value" => "",
                ]); ?>
              ...
              <div class="form-group">
                <?php echo $this->Form->control('products.flee', [
                  "label" => "無料プラン",
                  "class" => "form-control form-wide",
                  "value" => "",
                ]); ?>
              ...
              <div class="form-group">
                <?php echo $this->Form->control('products.trial', [
                  "label" => "無料トライアル",
                  "class" => "form-control form-wide",
                  "value" =>"",
                ]); ?>
              ...
              <div class="form-group">
                <?php echo $this->Form->control('products.url', [
                  "label" => "URL",
                  "class" => "form-control form-wide",
                  "value" => "",
                ]); ?>
              ...
              <div class="form-group">
              <label>大項目</label>
              <select class="parent form-control form-wide" id="" name="products[major]" disabled　required>
                        ...
                        <div class="form-group">
                        <label>中項目</label>
                                <select class="children form-control form-wide" id="" name="products[middle]" disabled required>
          ...
          <div class="box-footer">
            <button type="submit" formmethod="post" name="products[action]" value="insert" class="btn btn-info pull-right"><i class="fas fa-search"></i>登録する</button>
            <button type="submit" formmethod="get" name="products[action]" value="get" class="btn btn-info pull-right"><i class="fas fa-search"></i>検索する</button>
          </div>
          <!-- /.box-footer -->
        ...
        <div class="box">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-hover dataTable TableList userTableList">
              ...
              <tbody>
                <?php foreach ($resultproducts as $rowCount => $rowData) : ?>
                  <tr>
                    <?php
                    echo $this->Form->create(
                      $productTable,
                    ...
                    ?>
                       <td>
                      <?php echo $this->Form->hidden('products.id', [
                       "value" => $rowData["id"]
                        ]); ?>

                      <?php echo $this->Form->text('products.today', [
                        "label" => false,
                        "class" => "form-control form-wide",
                        "type"=>"date",
                    ...
                    <td>
                      <?php echo $this->Form->control('products.major', [
                        "label" => false,
                        "class" => "form-control form-wide",
                        "value" => $rowData["major"]
                      ]); ?>
                    ...
                    <td>
                      <?php echo $this->Form->control('products.middle', [
                        "label" => false,
                        "class" => "form-control form-wide",
                        "value" => $rowData["middle"]
                      ]); ?>
                    </td>
                    <td><button type="submit" name="products[action]" value="edit" class="btn btn-block"><i class="fa fa-edit"></i>編集</button></td>
                  <?php echo $this->Form->end(); ?>
                  <td>
