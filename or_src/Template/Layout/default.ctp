    ...
    <div class="container">
        <header>
            <div class="logo-area">
                <section class="logo-btn-00">
                    <h1><a href="/"><span>フリーランス支援サイト</span>「フリーダ」</a></h1>
                    <p>
        ...
        <footer>
            <div class="footer-00">
                <ul>
                    <li>
                        <p class="logo11 fz-lg">
                            FREELANCE フリーランスを楽しもう[BIRTH]
                        </p>
                        <p class="sns-icon">
                            <a href=""><img src="/images/sns-line.svg"></a>
                            <a href=""><img src="/images/sns-twitter.svg"></a>
                            <a href=""><img src="/images/sns-facebook.svg"></a>
                            <a href=""><img src="/images/sns-instagram.svg"></a>
                        </p>
                    </li>
                    <li>
                        <p><a href="">BIRTHとは</a></p>
                        <p><a href="">BIRTHの使い方</a></p>
                        <p><a href="">よくある質問</a></p>
                        <p><a href="">掲載希望の企業様へ</a></p>
                    </li>
                    <li>
                        <p><a href="">利用規約</a></p>
                ...
                <p class="copy">&copy; BIRTH All Rights Reserved</p>
            </div>
        </footer>
    </div>
                ...
                .then(function () {
                    $('bm-touroku', modal).html(`
                        ...
                        <p class="btn22">
                            ...
                            <button class="go" onclick="location.href='/my-bookmark'">ブックマークへ</button>
                        </p>
                    `);
                });
            return false;
