                    ...
                    <ul>
                                ...
                                <dd>
                                    <p>
                                        <label class="chackBtn mgnB00px">
                                            <input type="radio" id="" name="position" <?php if ($user->position === 'Questioner') { ?>checked="checked"<?php } ?> value="Questioner" class="">
                                            <span class="chackMark"></span> 質問者
                                        </label>
                                        <label class="chackBtn mgnB00px">
                                            <input type="radio" id="" name="position" <?php if ($user->position === 'Respondent') { ?>checked="checked"<?php } ?> value="Respondent" class="">
                                            <span class="chackMark"></span> 回答者
                                        </label>
                                        <label class="chackBtn mgnB00px">
                                            <input type="radio" id="" name="position" <?php if ($user->position === 'Expert') { ?>checked="checked"<?php } ?> value="Expert" class="">
                                            <span class="chackMark"></span> 専門家
                                        </label>
                                        <label class="chackBtn mgnB00px">
                                            <input type="radio" id="" name="position" <?php if ($user->position === 'Recruitment') { ?>checked="checked"<?php } ?> value="Recruitment" class="">
                                            <span class="chackMark"></span> 募集・宣伝
                                        </label>
                                    </p>
                                </dd>
                            </dl>
                        ...
                        <li>
                            <dl>
                                <dt>名　前</dt>
                                <dd>
                                    <p><?php echo $this->Form->input('kana', ['placeholder' => '田中 太郎', 'label' => false]); ?></p>
                                    <p><?php echo $this->Form->input('name', ['placeholder' => 'TANAKA TARO', 'label' => false]); ?></p>
                                </dd>
                            </dl>
                        </li>
                        <li>
                            <dl>
                                <dt>ニックネーム</dt>
                                <dd>
                                    <?php echo $this->Form->input('nickname', ['placeholder' => 'ダミー DAMMY', 'label' => false]); ?>
                                </dd>
                            </dl>
                        </li>
                        <li>
                                ...
                                <dd>
                                    <p>
                                        <label class="chackBtn">
                                            <input type="checkbox" id="" name="soudannaiyou" value="設計" class="">
                                            <span class="chackMark"></span> 設計
                                        </label>
                                        <label class="chackBtn">
                                            <input type="checkbox" id="" name="soudannaiyou" value="デザイン" class="">
                                            <span class="chackMark"></span> デザイン
                                        </label>
                                        <label class="chackBtn">
                                            <input type="checkbox" id="" name="soudannaiyou" value="ダミー" class="">
                                        ...
                                        <label class="chackBtn">
                                            <input type="checkbox" id="" name="soudannaiyou" value="その他" class="">
                                                    ...
                                                    <li>
                                                        <p class="selectbox">
                                                            <select name="work_history[<?php echo $index; ?>][start_month]" id="wh-month-start-01">
                                                                <option value="1" <?php if ($work_history->start_month == 1) { ?>selected="selected"<?php } ?>>一月</option>
                                                                <option value="2" <?php if ($work_history->start_month == 2) { ?>selected="selected"<?php } ?>>二月</option>
                                                                <option value="3" <?php if ($work_history->start_month == 3) { ?>selected="selected"<?php } ?>>三月</option>
                                                                <option value="4" <?php if ($work_history->start_month == 4) { ?>selected="selected"<?php } ?>>四月</option>
                                                                <option value="5" <?php if ($work_history->start_month == 5) { ?>selected="selected"<?php } ?>>五月</option>
                                                                <option value="6" <?php if ($work_history->start_month == 6) { ?>selected="selected"<?php } ?>>六月</option>
                                                                <option value="7" <?php if ($work_history->start_month == 7) { ?>selected="selected"<?php } ?>>七月</option>
                                                                <option value="8" <?php if ($work_history->start_month == 8) { ?>selected="selected"<?php } ?>>八月</option>
                                                                <option value="9" <?php if ($work_history->start_month == 9) { ?>selected="selected"<?php } ?>>九月</option>
                                                                <option value="10" <?php if ($work_history->start_month == 10) { ?>selected="selected"<?php } ?>>十月</option>
                                                                <option value="11" <?php if ($work_history->start_month == 11) { ?>selected="selected"<?php } ?>>十一月</option>
                                                                <option value="12" <?php if ($work_history->start_month == 12) { ?>selected="selected"<?php } ?>>十二月</option>
                                                            </select>
                                                        </p>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <p class="selectbox">
                                                            <select name="work_history[<?php echo $index; ?>][end_month]" id="wh-month-end-01">
                                                                ...
                                                                <option value="1" <?php if ($work_history->end_month == 1) { ?>selected="selected"<?php } ?>>一月</option>
                                                                <option value="2" <?php if ($work_history->end_month == 2) { ?>selected="selected"<?php } ?>>二月</option>
                                                                <option value="3" <?php if ($work_history->end_month == 3) { ?>selected="selected"<?php } ?>>三月</option>
                                                                <option value="4" <?php if ($work_history->end_month == 4) { ?>selected="selected"<?php } ?>>四月</option>
                                                                <option value="5" <?php if ($work_history->end_month == 5) { ?>selected="selected"<?php } ?>>五月</option>
                                                                <option value="6" <?php if ($work_history->end_month == 6) { ?>selected="selected"<?php } ?>>六月</option>
                                                                <option value="7" <?php if ($work_history->end_month == 7) { ?>selected="selected"<?php } ?>>七月</option>
                                                                <option value="8" <?php if ($work_history->end_month == 8) { ?>selected="selected"<?php } ?>>八月</option>
                                                                <option value="9" <?php if ($work_history->end_month == 9) { ?>selected="selected"<?php } ?>>九月</option>
                                                                <option value="10" <?php if ($work_history->end_month == 10) { ?>selected="selected"<?php } ?>>十月</option>
                                                                <option value="11" <?php if ($work_history->end_month == 11) { ?>selected="selected"<?php } ?>>十一月</option>
                                                                <option value="12" <?php if ($work_history->end_month == 12) { ?>selected="selected"<?php } ?>>十二月</option>
                                                            </select>
                                                        </p>
                                                    </li>
                                                </ul>
                                                    ...
                                                    <li>
                                                        <p class="selectbox">
                                                            <select name="education_history[<?php echo $index; ?>][start_month]" id="an-month-start-01">
                                                                <option value="1" <?php if ($education_history->start_month == 1) { ?>selected="selected"<?php } ?>>一月</option>
                                                                <option value="2" <?php if ($education_history->start_month == 2) { ?>selected="selected"<?php } ?>>二月</option>
                                                                <option value="3" <?php if ($education_history->start_month == 3) { ?>selected="selected"<?php } ?>>三月</option>
                                                                <option value="4" <?php if ($education_history->start_month == 4) { ?>selected="selected"<?php } ?>>四月</option>
                                                                <option value="5" <?php if ($education_history->start_month == 5) { ?>selected="selected"<?php } ?>>五月</option>
                                                                <option value="6" <?php if ($education_history->start_month == 6) { ?>selected="selected"<?php } ?>>六月</option>
                                                                <option value="7" <?php if ($education_history->start_month == 7) { ?>selected="selected"<?php } ?>>七月</option>
                                                                <option value="8" <?php if ($education_history->start_month == 8) { ?>selected="selected"<?php } ?>>八月</option>
                                                                <option value="9" <?php if ($education_history->start_month == 9) { ?>selected="selected"<?php } ?>>九月</option>
                                                                <option value="10" <?php if ($education_history->start_month == 10) { ?>selected="selected"<?php } ?>>十月</option>
                                                                <option value="11" <?php if ($education_history->start_month == 11) { ?>selected="selected"<?php } ?>>十一月</option>
                                                                <option value="12" <?php if ($education_history->start_month == 12) { ?>selected="selected"<?php } ?>>十二月</option>
                                                            </select>
                                                        </p>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <p class="selectbox">
                                                            <select name="education_history[<?php echo $index; ?>][end_month]" id="ah-month-end-01">
                                                                <option value="0"></option>
                                                                <option value="1" <?php if ($education_history->end_month == 1) { ?>selected="selected"<?php } ?>>一月</option>
                                                                <option value="2" <?php if ($education_history->end_month == 2) { ?>selected="selected"<?php } ?>>二月</option>
                                                                <option value="3" <?php if ($education_history->end_month == 3) { ?>selected="selected"<?php } ?>>三月</option>
                                                                <option value="4" <?php if ($education_history->end_month == 4) { ?>selected="selected"<?php } ?>>四月</option>
                                                                <option value="5" <?php if ($education_history->end_month == 5) { ?>selected="selected"<?php } ?>>五月</option>
                                                                <option value="6" <?php if ($education_history->end_month == 6) { ?>selected="selected"<?php } ?>>六月</option>
                                                                <option value="7" <?php if ($education_history->end_month == 7) { ?>selected="selected"<?php } ?>>七月</option>
                                                                <option value="8" <?php if ($education_history->end_month == 8) { ?>selected="selected"<?php } ?>>八月</option>
                                                                <option value="9" <?php if ($education_history->end_month == 9) { ?>selected="selected"<?php } ?>>九月</option>
                                                                <option value="10" <?php if ($education_history->end_month == 10) { ?>selected="selected"<?php } ?>>十月</option>
                                                                <option value="11" <?php if ($education_history->end_month == 11) { ?>selected="selected"<?php } ?>>十一月</option>
                                                                <option value="12" <?php if ($education_history->end_month == 12) { ?>selected="selected"<?php } ?>>十二月</option>
                                                            </select>
                                                        </p>
                                                    </li>
                                                </ul>
