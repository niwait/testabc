                ...
                <div class="main-area">
                    ...
                    <div class="item00">
                        <article class="entry">
                            ...
                            <section>
                                <p class="ttl"><?= $jobinfo["title"] ?></p>
                                <p class="company"><?= $jobinfo["company"] ?></p>
                                <p class="desc"><?= $jobinfo["text"] ?></p>
                       ...
                       <?php echo $this->Form->hidden('app.userId', [
                          "value" =>  $this->request->getSession()->read('Auth.id')
                        ]); ?>
                         <?php echo $this->Form->hidden('app.jobId', [
                          "value" => $this->request->getQuery("job.id")
                        ]); ?>
                            ...
                            <p class="btn22">
                                ...
                                <button class="go" type="submit" name="app[action]" value="send" class="something"><a id="wh">応募する</a></button> 
