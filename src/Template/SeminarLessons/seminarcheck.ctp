                    ...
                    <div class="item00">
                        <article class="entry">
                            ...
                            <ul>
                                ...
                                <li><?php echo $this->request->session()->read("subscribe.name")?></li>
                                <li><span>必須</span> フリガナ</li>
                                <li><?php echo $this->request->session()->read("subscribe.kana")?></li>
                                <li><span>必須</span> 郵便番号</li>
                                <li><?php echo $this->request->session()->read("subscribe.postcode")?></li>
                                <li><span>必須</span> 住 所</li>
                                <li><?php echo $this->request->session()->read("subscribe.address_a")?></li>
                                <li><span>必須</span> 上記以下の住所</li>
                                <li><?php echo $this->request->session()->read("subscribe.address_b")?></li>
                                <li><span class="gray">自由</span> マンション名・建物名</li>
                                <li><?php echo $this->request->session()->read("subscribe.address_c")?></li>
                                <li><span>必須</span> メールアドレス</li>
                                <li><?php echo $this->request->session()->read("subscribe.mail")?></li>
                                <li><span>必須</span> 電話番号</li>
                                <li><?php echo $this->request->session()->read("subscribe.tel")?></li>
                                <li><span>必須</span> 学歴・職歴</li>
                                <li><?php echo $this->request->session()->read("subscribe.educat")?></li>
                                <li><span>必須</span> 保有資格・スキル</li>
                                <li><?php echo $this->request->session()->read("subscribe.skill")?></li>
                                <li><span>必須</span> 自己PR</li>
                                <li><?php echo $this->request->session()->read("subscribe.pr")?></li>
                            </ul>
                            <form method="post" action="#">
                            <input type="hidden" name="_csrfToken" value="<?= $this->request->getParam('_csrfToken') ?>">
                            <p class="btn22">
             
                            <button class="back" type="submit"><a href="javascript:history.back();">戻る</a></button>
                                <button class="go" name="subscribe[submit]" value="submit" class="something">送信する</button>
                            </p>
                            </form>
                        </article>
                    </div>
