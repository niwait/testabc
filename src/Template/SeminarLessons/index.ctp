...
<div class="item00">
            ...
            <dt>
                ...
                <p class="icon">
                            ...
                            if(in_array($rowData['id'],$likes_info)){
                             ...
                             echo'<a href="#" class="js-modal-open"  onclick="seminarLike('.$rowData['id'].')">
    ...
    <article class="item-cld-04">
        ...
        <ul class="btn">
            ...
            <li>
            <p class="Apply">
            <a href="<?php echo sprintf("/SeminarLessons/seminarentry?seminar[id]=%s",$rowData["id"]);?>" class="something">応募する</a>
            </p>
            </li>
        </ul>
    </article>
