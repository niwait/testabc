          ...
          ?>
                ...
                <section class="cete-list-11">
                    ...
                    <ul>
                        <li>
                            <label>
                                <select class="parent" id="" name="seminars[major]" disabled　required>
                        ...
                        <li>
                            <label>
                                <select class="children" id="" name="seminars[middle]" disabled required>
                        ...
                        <li>
                            <label>
                                <select class="" name="seminars[prefecture]" id="" required>
                        ...
                        <li>
                        <button type="submit" formmethod="get" name="seminars[action]" value="get" class="btn btn-info pull-right"><i class="fas fa-search"></i>検索する</button>
                        </li>
                    </ul>
                ...
                <div class="main-area">
                    ...
                    <?php foreach ($seminarsinfo as $rowCount => $rowData) : ?>
                    <div class="item00">
