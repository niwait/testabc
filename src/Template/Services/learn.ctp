            ...
            <div class="contents">
                ...
                <section class="cete-list-11">
                    ...
                    <ul>
                        ...
                        <li>
                            <input type="text" name="name" placeholder="フリーワード">
                        </li>
                        <li>
                    ...
                    <div class="item00">
                            ...
                            <dl>
                                ...
                                <dd>
                                    <section class="name-data">
                                        <p class="name"><a href="">セミナー・レッスンのタイトル</a></p>
                                        <p class="data">登録日：2020/07/25</p>
                                    </section>
                                    <p class="anything">会社名・団体名・個人名</p>
                        ...
                        <article class="item-cld-04">
                            <ul class="desc">
                                ...
                                <li>東京｜渋谷</li>
                                <li>日時</li>
                                <li>2020/08/25   18時～</li>
                                <li>内容</li>
                                <li>Webライティングの基礎を身につける！60分集中レッスン</li>
                                <li>費用</li>
                                <li>￥6,000 -</li>
                            </ul>
                            <ul class="btn">
                                <li><p class="view-details"><a href="https://www.theatre.co.jp/lesson/" target="_blank">詳細を見る</a></p></li>
                                <li><p class="Apply"><a href="">応募する</a></p></li>
                            </ul>
                        </article>
                    </div>
