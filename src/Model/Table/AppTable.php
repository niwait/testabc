 ...
 * @method \App\Model\Entity\App newEntity($data = null, array $options = [])
 ...
 * @method \App\Model\Entity\App[] patchEntities($entities, array $data, array $options = [])
